...
| 11 | 11-08 | Enable + configure a project; operator-vs-admin permission split (admin cannot disconnect, operator can) | H/E | `tests/e2e/test_e2e_epic11_enable_and_configure.py::test_epic11_enable_configure_and_permission_split` |
