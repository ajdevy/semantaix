...
- **Persona-name not embedded in caption.** The caption is operator-authored — the bot does NOT prepend "Николай: …". The persona influences only the surrounding scoping/pitching text.
